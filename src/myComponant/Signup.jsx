        ...
        <div style={style1}>
            ...
            <div className="p-4" style={style3}>
                <div className="border border-primary rounded p-1 px-2">
                    <input type="text" className="form-control m-1" id="floatingInput" placeholder="Name:Shunya" />
                    ...
                    <input type="password" className="form-control m-1" id="floatingPassword" placeholder="Confirm Password"/>
                </div>
                <button className="btn btn-outline-success mt-3 mx-1">Sign Up</button>
            </div>
            <div style={style4}>
